...
**What crosses to the next president.** Four headings, kept current as things
are found rather than written at the close. *Nothing yet* is an answer; an
omitted heading is not.
...
**None of it binds them.** Evidence, not instruction.
