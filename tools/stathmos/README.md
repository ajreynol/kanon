...
is real: a rod measures a tree against rules that can be checked, and a weight
is what you put on the other pan when the thing being weighed is a judgement.
