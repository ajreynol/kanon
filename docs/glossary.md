...
argument about which of the theories and options [cvc5](#cvc5)’s safe mode switches
off are worth making proof-supported, and in what order — a ranking a maintainer can
disagree with, never a measurement. It is not a Greek word, taken by the maintainer
for continuity with this ecosystem’s other derived names (e.g. [ynoia](#ynoia)).
