...
person with a closing condition; the pursuit ends if the target’s maintainers
ask. It describes the pursuing repository’s activity. From Greek διώκτης,
“pursuer.” See
[LAW 10](laws.md#law-10--in-dioktes-when-we-go-looking-for-defects-in-somebody-elses-tool).
...
comparison and is not proposed for promotion. Its released artifact and
published contribution are recorded separately, and neither imposes obligations
on it. See
[LAW 9](laws.md#law-9--released-is-not-published-and-tracking-respects-the-difference).
...
kept during it. The laws prescribe no fixed duration. See
