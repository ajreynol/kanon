...
status, local policy results, hosted CI results, declaration drift and missing
evidence, and reporting the declared investigations under
...
**Owns:** the public `scripts/eo_status_audit`, `scripts/eo_tooling_audit`,
`scripts/eo_dioktes_audit` and `scripts/eo_ci_audit` launchers,
...
[`tools/stathmos/audits/ci_audit.py`](../tools/stathmos/audits/ci_audit.py),
