...
executed:* one office, **bestowed**, no election, no mechanism to hold one. Laws
written by a different repository than the one they bind, which is the first
real separation and arrives by the office moving rather than by design. The only
